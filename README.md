...
- 2、执行算法
  ...
  ![setting2](screenshots/setting2.png)
...
- 在线更新
  ...
  ![updata](screenshots/updata.png)

  - 检测到新版本发布时，自动显示“有新内容”按钮，同时输出日志。
  - 点击“有新内容”按钮，则弹出更新说明，选择是否更新。
  - 如果选择更新，系统会自动下载更新包，打开下载路径。然后用户可以手动安装更新包。
