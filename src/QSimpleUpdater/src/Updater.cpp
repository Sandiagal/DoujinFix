...
Updater::Updater()
{
    ...
    connect (m_downloader, SIGNAL (quitNow ()),
             this,         SIGNAL (quitNow ()));
...
void Updater::setUpdateAvailable (const bool available)
{
    ...
    {
        QString text = m_changelog;
        text += tr("<p>Would you like to download the update now?</p>");
        if (m_mandatoryUpdate)
        {
            text = tr ("<p>Would you like to download the update now? This is a mandatory update, exiting now will close the application</p>");
        }
